...
public class Upload {
    ...
    public static String uploadFile(InputStream filestream, File savePath, String filename){
        ...
        String realSavePath = savePath+"\\"+filename;//realSvePath: C:\ftp\ChangJiang\rolling\文件名.jpg
        //创建一个输出流
