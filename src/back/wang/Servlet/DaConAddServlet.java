...
/**
 * @author wwx-sys
 * @time 2021-03-06-10:58
 * @description 添加数据联系人接口
 */
@WebServlet("/DaConAddServlet")
public class DaConAddServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String result = adminService.daConAdd(da_con);
