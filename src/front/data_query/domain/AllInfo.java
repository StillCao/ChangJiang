...
public class AllInfo {
    ...
    public AllInfo(Integer id, String name, String sploc, String docname, Date up_time, Double point1_lat, Double point1_lon, Double point2_lat, Double point2_lon, String topic_w1, String topic_w2, String topic_w3, String topic_cfi, String da_summ, String da_size, String da_url, Integer up_id, Integer da_type, String image, String uper_name, String uper_place, String file_url, String sample_url, String datm_range, String da_source, String da_method, String da_projection, String da_quality, String da_refer, Date da_time, String subj_cfi) {
        this.id = id;
        this.name = name;
        this.sploc = sploc;
